...
void TestProcess(void)
{
	...
	{		
		...
		ret = art310.ChangeAccessPassword("00000000","11111111"); 	// old password, new password
		printf("	Ret:%d\n",ret);
		...
		/*
		//memset(result,'\0', sizeof(result));
		//printf("Function14:	Kill Tag E2003412DC03011880139055 ");
		//ret = art310.KillTag(result,"44444444");
		//printf("	Ret:%d\n",ret);
		//printf("	[%s]\n",result);
		*/
